...
import { SalonauthGuard } from './guard/salonauth.guard';
...
import { SalonAddcategorybysalonidSalonComponent } from './components/salon/salon-addcategroybysalonid-salon/salon-addcategorybysalonid-salon.component';
...
const routes: Routes = [
  ...
  {path:'signup',component:SignupComponent},
    ...
    {
      path: 'salon-content', component: HotelContentComponent,
      children: [
